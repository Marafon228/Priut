...
using PriutWebAPI.Models;
using PriutWebAPI.Models.JSON;

namespace PriutWebAPI.Controllers
{
    public class UsersController : ApiController
    {
        ...
        public IHttpActionResult AuthSignIn(AuthSignIn user)
        {
            ...
            {
                return Ok(new AuthSignInResponse() { Id = userNew.Id, Login = userNew.Login, Password = userNew.Password, FIO = userNew.FIO, Adress = userNew.Address, Email = userNew.Email, Phone = userNew.Phone });
            }
        ...
        public IHttpActionResult RegisterUser(RegisterUser user)
        {
            ...
            var userNew = new User {Login = user.Login, Password = user.Password, FIO = user.FIO, Address = user.Adress, Email = user.Email, Phone = user.Phone };
            db.User.Add(userNew);
            db.SaveChanges();
